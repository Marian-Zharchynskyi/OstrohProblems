    ...
    public partial class UserSingleRole : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("00000000-0000-0000-0001-000000000001"), "[\"\\u0414\\u043E\\u0440\\u043E\\u0433\\u0438\"]", null, null, new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000011"), null, "Велика яма на дорозі біля будинку №15. Потребує термінового ремонту.", 50.3294, 26.514399999999998, null, "Нова", "Розбита дорога на вул. Академічна", new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("00000000-0000-0000-0001-000000000002"), "[\"\\u041E\\u0441\\u0432\\u0456\\u0442\\u043B\\u0435\\u043D\\u043D\\u044F\"]", null, null, new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000011"), null, "Вже тиждень не світять ліхтарі на ділянці від будинку №5 до №15.", 50.328499999999998, 26.512499999999999, null, "Нова", "Не працює вуличне освітлення на вул. Семінарська", new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("00000000-0000-0000-0001-000000000003"), "[\"\\u0421\\u043C\\u0456\\u0442\\u0442\\u044F\"]", null, null, new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc), new Guid("00000000-0000-0000-0000-000000000011"), null, "Сміттєві контейнери не вивозяться вже 3 дні, сміття розкидане навколо.", 50.330100000000002, 26.5167, null, "Нова", "Переповнені сміттєві баки біля ринку", new DateTime(2024, 1, 15, 10, 0, 0, 0, DateTimeKind.Utc) },
