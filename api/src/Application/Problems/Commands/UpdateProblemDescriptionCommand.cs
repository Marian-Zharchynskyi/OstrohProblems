...
public record UpdateProblemDescriptionCommand : IRequest<Result<Problem, ProblemException>>
{
    public required Guid ProblemId { get; init; }
    public required string Description { get; init; }
}

public class UpdateProblemDescriptionCommandHandler(
    IProblemRepository problemRepository)
    : IRequestHandler<UpdateProblemDescriptionCommand, Result<Problem, ProblemException>>
{
    public async Task<Result<Problem, ProblemException>> Handle(
        UpdateProblemDescriptionCommand request,
