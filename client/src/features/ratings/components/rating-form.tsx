...
export function RatingForm({ open, onOpenChange, onSubmit, initialData, isLoading }: RatingFormProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>{initialData ? 'Редагувати рейтинг' : 'Створити рейтинг'}</DialogTitle>
        </DialogHeader>
          ...
          <div className="space-y-4 py-4">
            {!initialData && (
              <FormField
                ...
                onChange={(value) => setFormData({ ...formData, problemId: value as string })}
                required
