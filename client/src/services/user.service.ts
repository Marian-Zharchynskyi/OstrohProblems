...
export const userService = {
  ...
  async getPagedUsers(page: number = 1, pageSize: number = 10, token: string): Promise<PagedResult<UserDto>> {
    const response = await axios.get<BackendPagedResponse<BackendUserDto>>(`${API_URL}/users/paged`, {
  ...
  async getUserById(userId: string, token: string): Promise<UserDto> {
    const response = await axios.get<BackendUserDto>(`${API_URL}/users/get-by-id/${userId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async updateUser(userId: string, data: UpdateUserDto, token: string): Promise<UserDto> {
    const response = await axios.put<BackendUserDto>(`${API_URL}/users/update/${userId}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async uploadUserImage(userId: string, imageFile: File, token: string): Promise<UserDto> {
    const formData = new FormData();
    formData.append('imageFile', imageFile);

    const response = await axios.put<BackendUserDto>(`${API_URL}/users/image/${userId}`, formData, {
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  async deleteUser(userId: string, token: string): Promise<UserDto> {
    const response = await axios.delete<BackendUserDto>(`${API_URL}/users/delete/${userId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async deleteUserImage(userId: string, token: string): Promise<UserDto> {
    const response = await axios.delete<BackendUserDto>(`${API_URL}/users/image/${userId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async updateUserRoles(userId: string, roleId: string, token: string): Promise<UserDto> {
    const response = await axios.put<BackendUserDto>(`${API_URL}/users/update-roles/${userId}`, JSON.stringify(roleId), {
      headers: {
        Authorization: `Bearer ${token}`,
  ...
  async createUser(data: CreateUserDto, token: string): Promise<UserDto> {
    const response = await axios.post<BackendUserDto>(`${API_URL}/users/create`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async changePassword(userId: string, data: ChangePasswordDto, token: string): Promise<UserDto> {
    const response = await axios.put<BackendUserDto>(`${API_URL}/users/change-password/${userId}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  async setPassword(userId: string, data: SetPasswordDto, token: string): Promise<UserDto> {
    const response = await axios.put<BackendUserDto>(`${API_URL}/users/set-password/${userId}`, data, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
