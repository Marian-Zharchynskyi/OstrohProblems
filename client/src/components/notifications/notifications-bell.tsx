      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-80 max-h-96 overflow-y-auto rounded-lg border border-gray-200 bg-white shadow-lg z-50">
          ...
          {notifications.length === 0 ? (
            <div className="px-4 py-8 text-center text-sm text-gray-500">Немає нових нотифікацій</div>
          ) : (
                ...
                <button
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-gray-900 font-medium break-words whitespace-normal">{notification.message}</p>
                      <p className="text-xs text-gray-500 mt-1" title={notification.problemTitle}>
                        {notification.problemTitle && notification.problemTitle.length > 50 ? `${notification.problemTitle.substring(0, 50)}...` : notification.problemTitle}
                      </p>
